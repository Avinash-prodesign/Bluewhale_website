...
<head>
	<title>BlueWhale Admin Login</title>
	<meta charset="utf-8">
						...
						<div class="content">
							<div class="header">
								<div class="logo text-center">
								    <img class="img-fluid" src="assets/img/logo-dark.png"/>
							    </div>
								<p class="lead">Login to your account</p>
							</div>
							<form class="form-auth-small" action="php/admin-login.php" method="post">
